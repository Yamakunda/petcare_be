...
router.get("/listUser", auth_middleware.requireAuth,verify_middleware.verifyRole("admin","doctor"), controller.getListUsers);
...
router.put("/", auth_middleware.requireAuth,verify_middleware.verifyRole("user","admin","doctor"), controller.updateAccount); 
