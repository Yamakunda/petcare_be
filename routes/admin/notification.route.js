...
router.get("/list/:user_id", auth_middleware.requireAuth,verify_middleware.verifyRole("admin","doctor"), controller.getUserListNotifications);
...
router.delete("/:id",auth_middleware.requireAuth, controller.deleteNotification);
